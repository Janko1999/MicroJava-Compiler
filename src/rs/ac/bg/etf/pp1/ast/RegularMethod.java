...
public class RegularMethod extends MethodDecl {
    ...
    public RegularMethod (MethodTypeName MethodTypeName, FormPars FormPars, VarDeclarations VarDeclarations, StatementList StatementList) {
